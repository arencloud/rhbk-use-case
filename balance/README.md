...
- namespace `balance`
- restricted Deployment using `quay.io/arencloud/balance:0.1.0`
...
Update the GitOps image tag when releasing a new version. Do not deploy `latest`; use immutable version tags such as `quay.io/arencloud/balance:0.1.0`.
