...
./scripts/build-image.sh 0.1.5 multiarch
```
...
- namespace `balance`
- restricted Deployment using `quay.io/arencloud/balance:0.1.5`
...
Update the GitOps image tag when releasing a new version. Do not deploy `latest`; use immutable version tags such as `quay.io/arencloud/balance:0.1.5`.
